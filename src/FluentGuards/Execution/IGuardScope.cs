...
//        /// </param>
//        IGuardScope ForCondition(bool condition);
...
//        /// </param>
//        IGuardScope BecauseOf(string because, params object[] becauseArgs);
...
//        /// <param name="message">The format string that represents the failure message.</param>
//        /// <param name="args">Optional arguments to any numbered placeholders.</param>
//        IGuardScope WithExpectation(string message, params object[] args);

//        /// <summary>
//        /// Defines the name of the subject in case this cannot be extracted from the source code.
//        /// </summary>
//        IGuardScope WithDefaultIdentifier(string identifier);
...
//        /// </remarks>
//        IGuardScope UsingLineBreaks { get; }
