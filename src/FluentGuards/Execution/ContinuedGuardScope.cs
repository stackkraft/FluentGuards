...
//{
//    /// <summary>
//    /// Allows chaining multiple Guard scopes together using <see cref="Continuation.Then"/>.
//    /// </summary>
//    /// <remarks>
//    /// If the parent scope has captured a failed Guard,
//    /// this class ensures that successive Guards are no longer evaluated.
//    /// </remarks>
//    public sealed class ContinuedGuardScope : IGuardScope
//    {
//        private readonly GuardScope predecessor;
//        private readonly bool continueAsserting;

//        internal ContinuedGuardScope(GuardScope predecessor, bool continueAsserting)
//        {
...
//        /// <inheritdoc/>
//        public IGuardScope ForCondition(bool condition)
//        {
//            if (continueAsserting)
//            {
...
//        /// <inheritdoc/>
//        public IGuardScope BecauseOf(string because, params object[] becauseArgs)
//        {
//            if (continueAsserting)
//            {
...
//        /// <inheritdoc/>
//        public IGuardScope WithExpectation(string message, params object[] args)
//        {
//            if (continueAsserting)
//            {
...
//        /// <inheritdoc/>
//        public IGuardScope WithDefaultIdentifier(string identifier)
//        {
//            if (continueAsserting)
//            {
...
//        /// <inheritdoc/>
//        public IGuardScope UsingLineBreaks => predecessor.UsingLineBreaks;
