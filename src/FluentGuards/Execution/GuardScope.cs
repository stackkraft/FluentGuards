...
//    /// </remarks>
//    public sealed class GuardScope : IGuardScope
//    {
//        #region Private Definitions

//        private readonly FormattingOptions formattingOptions = GuardOptions.FormattingOptions.Clone();
//        private readonly IGuardStrategy assertionStrategy;
//        private readonly ContextDataItems contextData = new();

//        private Func<string> reason;

//        private static readonly AsyncLocal<GuardScope> CurrentScope = new();
//        private Func<string> callerIdentityProvider = () => CallerIdentifier.DetermineCallerIdentity();
//        private GuardScope parent;
...
//        /// </summary>
//        public GuardScope(string context)
//            : this()
//        {
...
//        /// </summary>
//        public GuardScope()
//            : this(new CollectingGuardStrategy())
//        {
//        }
...
//        public GuardScope(IGuardStrategy assertionStrategy)
//            : this(assertionStrategy, GetCurrentGuardScope())
//        {
//            SetCurrentGuardScope(this);
//        }
...
//        /// and which will not throw until the scope is disposed.
//        /// </summary>
//        public GuardScope(Lazy<string> context)
//            : this()
//        {
//            Context = context;
//        }
...
//        /// <exception cref="ArgumentNullException">Thrown when trying to use a null strategy.</exception>
//        private GuardScope(IGuardStrategy assertionStrategy, GuardScope parent)
//        {
...
//        /// </summary>
//        public static GuardScope Current
//        {
//#pragma warning disable CA2000 // GuardScope should not be disposed here
//            get
//            {
//                return GetCurrentGuardScope() ?? new GuardScope(new DefaultGuardStrategy(), parent: null);
//            }
//#pragma warning restore CA2000
//            private set => SetCurrentGuardScope(value);
//        }

//        /// <inheritdoc cref="IGuardScope.UsingLineBreaks"/>
//        public GuardScope UsingLineBreaks
//        {
//            get
//            {
...
//        /// </summary>
//        public GuardScope BecauseOf(Reason reason)
//        {
//            return BecauseOf(reason.FormattedMessage, reason.Arguments);
//        }

//        /// <inheritdoc cref="IGuardScope.BecauseOf(string, object[])"/>
//        public GuardScope BecauseOf(string because, params object[] becauseArgs)
//        {
//            reason = () =>
//            {
//                try
...
//        /// <inheritdoc cref="IGuardScope.WithExpectation(string, object[])"/>
//        public GuardScope WithExpectation(string message, params object[] args)
//        {
...
//        /// <inheritdoc cref="IGuardScope.ForCondition(bool)"/>
//        public GuardScope ForCondition(bool condition)
//        {
//            succeeded = condition;
...
//        public GuardScope ForConstraint(OccurrenceConstraint constraint, int actualOccurrences)
//        {
...
//        /// <inheritdoc cref="IGuardScope.WithDefaultIdentifier(string)"/>
//        public GuardScope WithDefaultIdentifier(string identifier)
//        {
...
//        private static GuardScope GetCurrentGuardScope()
//        {
//            return CurrentScope.Value;
//        }

//        private static void SetCurrentGuardScope(GuardScope scope)
//        {
...
//        IGuardScope IGuardScope.ForCondition(bool condition) => ForCondition(condition);

//        IGuardScope IGuardScope.BecauseOf(string because, params object[] becauseArgs) => BecauseOf(because, becauseArgs);

//        IGuardScope IGuardScope.WithExpectation(string message, params object[] args) => WithExpectation(message, args);

//        IGuardScope IGuardScope.WithDefaultIdentifier(string identifier) => WithDefaultIdentifier(identifier);

//        IGuardScope IGuardScope.UsingLineBreaks => UsingLineBreaks;
